...
/* Non-blocking variant: issues a single 2D DMA2D transfer and returns immediately.
 * Caller must register hdma2d_eval.XferCpltCallback / XferErrorCallback to be notified.
 */
